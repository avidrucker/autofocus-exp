...
async function generateTsLintConfig(options) {
    return generateConfigFile(options, './tslint.json', formatJson(exports.TSLINT_CONFIG));
}
...
async function generatePrettierConfig(options) {
    const style = await util_1.readFilep(path.join(__dirname, '../../prettier.config.js'), 'utf8');
